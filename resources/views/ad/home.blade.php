...
<div class="container home">
    ...
    <div class="row justify-content-around">
        <a href="/plannings" class=" col-2 buttonHome">
            <h3>Voir le planning de la semaine</h3>
            <i class="fas fa-road"></i>
        </a>
        <a href="/plannings/check" class=" col-4 buttonHome">
            <h1>Planning global</h1>
            <p>- voir, modifier, valider semaine prochaine</p>
            <i class="fas fa-dragon"></i>
        </a>
        <a href="/plannings/create" class="col-3 buttonHome"> 
            <h1>Remplir la semaine prochaine</h1>
            <i class="fas fa-puzzle-piece"></i>
        </a>
        <a href="/freedays" class=" col-2 buttonHome">
